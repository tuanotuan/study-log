...
Form upload anh submit qua API routes (`/api/commits`, `/api/profile`) de tranh loi Server Action body limit. Browser chan nhanh file qua lon; server van validate anh commit toi da 5MB va avatar toi da 3MB.
